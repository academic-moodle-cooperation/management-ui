...
- **Don't bundle `react`, `@oc-mui/*`, or other shared runtime deps into the JAR** — they're provided by the host. See [`docs/architecture/CONTRACTS.md` § 5](../../docs/architecture/CONTRACTS.md#5-shared-runtime-dependencies) for the full list.

## See also

- [`docs/plugins/distribution.md`](../../docs/plugins/distribution.md) — comparison of the four distribution paths (in-tree, `.local-plugins/`, JAR, CDN).
- [`docs/architecture/CONTRACTS.md`](../../docs/architecture/CONTRACTS.md) — manifest, runtime API, theme, config, and shared-runtime-deps contracts.
