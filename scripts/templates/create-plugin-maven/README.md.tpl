...
- [`docs/plugins/distribution.md`](https://github.com/academic-moodle-cooperation/management-tool/blob/HEAD/docs/plugins/distribution.md) — comparison of the four distribution paths (in-tree, `.local-plugins/`, JAR, CDN).
- [`docs/architecture/CONTRACTS.md`](https://github.com/academic-moodle-cooperation/management-tool/blob/HEAD/docs/architecture/CONTRACTS.md) — manifest, runtime API, theme, config, and shared-runtime-deps contracts.
