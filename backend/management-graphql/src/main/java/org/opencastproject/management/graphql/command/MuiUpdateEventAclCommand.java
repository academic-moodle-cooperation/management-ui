...
public class MuiUpdateEventAclCommand extends UpdateEventAclCommand {

  private final String workflowPublishId;

  public MuiUpdateEventAclCommand(final Builder builder) {
    super(builder);
  ...
  public static class Builder extends UpdateEventAclCommand.Builder {
    ...
    @Override
    public MuiUpdateEventAclCommand build() {
      validate();
      return new MuiUpdateEventAclCommand(this);
    }
  }
