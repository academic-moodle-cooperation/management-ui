...
@GraphQLName(MuiSeriesInfo.TYPE_NAME)
public class MuiSeriesInfo {

  public static final String TYPE_NAME = "MuiSeriesInfo";

  private final GqlSeries series;

  public MuiSeriesInfo(GqlSeries series) {
    this.series = series;
  }

  @GraphQLField
  public boolean isPublic() {
    String accessPolicy = series.getSeries().getAccessPolicy();
