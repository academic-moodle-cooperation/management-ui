...
│   │   ├── ui/                  # ⚠️ AUTO-GENERATED: Base UI primitives (shadcn/ui)
...
### ⚠️ Important: Auto-Generated Components

The `src/components/ui/` folder contains **shadcn/ui components** that are automatically generated by the shadcn CLI. 

**DO NOT manually edit files in this folder** - They will be overwritten when you run:
```bash
npx shadcn@latest add [component-name]
```

For details, see: [`src/components/ui/README.md`](src/components/ui/README.md)

If you need to customize a component:
1. Copy it to a different location (e.g., `src/components/custom/`)
2. Use the plugin system to override via `component-override` extension points
3. Fork the component, but be aware it will be overwritten on next shadcn update
