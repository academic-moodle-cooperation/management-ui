...
export function Appshell({ children }: { children: React.ReactNode }) {
  return (
    <SidebarProvider>
      <AppSidebar sidebarProps={{ className: "border-r border-sidebar-border" }} headerProps={{ className: "h-16 p-0 flex items-center justify-center" }} />
        ...
        <footer className="bg-footer flex h-16 shrink-0 items-center gap-2 border-t border-border transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12">
          <div className="flex items-center gap-2 px-4 w-full justify-between">
            ...
            <ComponentResolver
              ...
              defaultComponent={() => <div className="flex w-full justify-between">
