...
export const MANAGED_ACL_ORDER_BY_FIELDS = ["name"] as const;
export const PLAYLIST_ORDER_BY_FIELDS = ["creator","deletionDate","description","organization","title","updated"] as const;
export const SERIES_ORDER_BY_FIELDS = ["contributors","created","creator","description","language","license","publishers","rightHolder","subject","title"] as const;
