## API Report File for "@opencast-mui/query"

> Do not edit this file. It is a report generated by [API Extractor](https://api-extractor.com/).

```ts

import { AppConfig } from '@opencast-mui/ui-config';
import { FetchNextPageOptions } from '@tanstack/react-query';
import { gql } from 'graphql-request';
import { GraphQLClient } from 'graphql-request';
import { InfiniteData } from '@tanstack/react-query';
import { InfiniteQueryObserverResult } from '@tanstack/react-query';
import { MatomoConfig } from '@opencast-mui/ui-config';
import { NoInfer as NoInfer_2 } from '@tanstack/react-query';
import { PluginManager } from '@opencast-mui/plugin-system';
import { PluginsConfig } from '@opencast-mui/ui-config';
